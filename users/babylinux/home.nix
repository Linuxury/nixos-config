...

{
  ...
  xdg.mimeApps.defaultApplications = {
    "x-scheme-handler/http"  = [ "firefox.desktop" "helium.desktop" ];
    "x-scheme-handler/https" = [ "firefox.desktop" "helium.desktop" ];
    "text/html"              = [ "firefox.desktop" "helium.desktop" ];
    "application/xhtml+xml"  = [ "firefox.desktop" "helium.desktop" ];
  };
