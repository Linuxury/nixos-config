# ===========================================================================
# modules/desktops/cosmic/default.nix — COSMIC Desktop Environment
#
...

{
  ...
  # =========================================================================
  # Wallpaper slideshow + matugen theming + GTK theme — injected into every HM user
  #
  # home-manager.sharedModules adds these HM modules to all users on any host
  # that imports cosmic/default.nix. No need to import them individually in
  # each user's home.nix — they're automatic for every COSMIC desktop.
  # =========================================================================
  home-manager.sharedModules = [
    ../../services/wallpaper-slideshow/default.nix
    ./themes/default.nix
  ];
