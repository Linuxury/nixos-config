# ===========================================================================
# modules/users/babylinux/description/default.nix — Set babylinux's display name via agenix
#
# Same pattern as linuxury/description/default.nix — decrypts the real name at
