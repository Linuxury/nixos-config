...
if status is-interactive
    ...
    function nru --description "git pull + nixos-rebuild switch + update nixpkgs"
        ...
        sudo systemd-inhibit --what=sleep:idle --who=nixos-rebuild --why="NixOS rebuild in progress" nixos-rebuild switch --flake $NIXOS_CONFIG --update-input nixpkgs --print-build-logs
    end
