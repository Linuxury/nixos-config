# ===========================================================================
# modules/system/graphical/helium/default.nix — Helium browser keyring integration
#
...
#
# Imported by all graphical users alongside the package in graphical/default.nix.
# ===========================================================================
