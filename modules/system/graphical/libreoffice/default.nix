# ===========================================================================
# modules/system/graphical/libreoffice/default.nix — LibreOffice via Flathub (system-wide)
#
# Imported by: system/graphical/default.nix (all graphical hosts)
#
...
#           (both provided by system/graphical/default.nix).
# ===========================================================================
