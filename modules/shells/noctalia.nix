# ===========================================================================
# modules/shells/noctalia.nix — Noctalia shell layer
#
...
let cfg = config.shell.noctalia; in

{
  options.shell.noctalia.enable = lib.mkEnableOption "Noctalia shell layer";
  ...
  config = lib.mkIf cfg.enable {
    ...
    home-manager.sharedModules = [
      ...
      ../services/noctalia-color-sync.nix
