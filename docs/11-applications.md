...
- [Fastfetch](#fastfetch)
- [Firefox](#firefox)
- [Obsidian and Syncthing](#obsidian-and-syncthing)
- [FreshRSS and Fluent Reader](#freshrss-and-fluent-reader)
...
Buffer-local — active when LSP is attached to the current file.
...
Obsidian is the note-taking app used by linuxury. The vault lives at `~/Obsidian/` and is synced across machines and phone via Syncthing.
...
| Device discovery | Manual pairing via web UI |
